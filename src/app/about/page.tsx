          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Jason Lee</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Jason, a computational engineering honors and robotics student at UT Austin
              with a passion for production ML and AI systems engineering. I&apos;m interested in building
              intelligent systems that solve real-world problems at scale. My journey has taken me from
              AI research in Kyoto, Japan to platform engineering at Samsung, and now to Amazon&apos;s Guides Program.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me playing guitar in a band, running marathons,
              playing volleyball, cooking, capturing moments through photography, gaming, or editing videos.
            </p>
